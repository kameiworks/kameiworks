...
## プライバシーポリシー
当サイト（[会社員小説家の法則—仕事続けながら小説が書けたときの記録](/)）における、個人情報の取り扱いについて、以下の通りに定めます。
1. 個人情報の取得について
...
Google Analyticsの利用規約・ポリシーについては、[Google Analytics サービス利用規約](https://marketingplatform.google.com/about/analytics/terms/jp/)および[Google のサービスを使用するサイトやアプリから収集した情報の Google による使用](https://policies.google.com/technologies/partner-sites?hl=ja)をご確認ください。
4. 広告配信について
当サイトでは、第三者配信の広告サービス（Google AdSense 等）を利用して広告を掲載する場合があります。
これらの広告配信事業者は、ユーザーの興味に応じた広告を表示するために Cookie を使用することがあります。Cookie を用いて個人を特定する情報は含まれません。
パーソナライズド広告を無効にする方法や、Cookie に関する詳細は、[広告 – プライバシーと規約 – Google](https://policies.google.com/technologies/ads?hl=ja)をご確認ください。
Google がパートナーサイトのアプリやサイトでの広告掲載に Cookie を使用する方法については、[Google のサービスを使用するサイトやアプリから収集した情報の Google による使用](https://policies.google.com/technologies/partner-sites?hl=ja)をご覧ください。
5. 第三者への開示・提供の禁止
当サイトは、法令に基づき開示することが必要である場合を除き、ご本人様の同意なく個人情報を第三者に開示・提供することはありません。
なお、前項の広告配信等に伴い、広告配信事業者が Cookie 等の技術により情報を取得・利用する場合があります。その取扱いは当該事業者のプライバシーポリシー等に従います。
6. プライバシーポリシーの変更
